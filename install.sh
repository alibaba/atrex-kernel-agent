...
def handle_post_tool_use(payload: dict, target: str) -> int:
    ...
    continuation_prompt = (
        ...
        "Note: full hardware profiling (profile_kernel.sh for AMD, profile_iter_nvidia.sh for NVIDIA) is performed "
...
def memory_write_continuation_prompt(workspace: Path, version: str) -> str:
    ...
    return (
        ...
        "enter Stage 1: run full hardware profiling using profile_kernel.sh (AMD) or profile_iter_nvidia.sh (NVIDIA) "
