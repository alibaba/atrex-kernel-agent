...
- [2026-09] **Atrex Kernel Agent v0.3.0** adds long-horizon fast/full/goal episodes, production campaign controls, isolated SSH GPU execution with recovery, local plugins, and a structured GPU Wiki. See the [v0.3.0 release notes](docs/releases/v0.3.0.md).
