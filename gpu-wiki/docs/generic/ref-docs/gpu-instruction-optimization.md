...
- **NVIDIA Profiling**: [NCU Profiling Guide](../../nvidia/common/ref-docs/ncu-profiling-guide.md) — practical tool usage for Roofline analysis
- **AMD Profiling**: [rocprofv3 Instruction-Level Profiling](../../amd/cdna3/ref-docs/gluon/profiling_guide.md)
