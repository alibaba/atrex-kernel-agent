...
- **NVIDIA Profiling**: [NCU/Nsight Optimization](../../nvidia/README.md) -- Detailed documentation on NVIDIA profiling tools
- **AMD Optimization**: [AMD General Optimization](../../amd/README.md) -- AMD GPU optimization techniques
- **Triton Hands-On**: [Triton Kernel Optimization Patterns Hands-On](../kernel-opt/hands-on/README.md) -- 8 Triton optimization patterns
