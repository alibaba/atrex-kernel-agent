...
Comprehensive core knowledge from the Zhihu community on optimizing common GPU operators (softmax, LayerNorm, reduce, etc.). Supplements CUDA-level operator optimization details not covered in [Online Softmax & Flash Attention Hands-on](../kernel-opt/hands-on/online-softmax-flash-attention.md) and [Fused Kernel Patterns Hands-on](../kernel-opt/hands-on/fused-kernel-patterns.md).
...
- [Online Softmax and Flash Attention Hands-On](../kernel-opt/hands-on/online-softmax-flash-attention.md) -- Triton implementation of the online softmax algorithm and Flash Attention
- [Fused Kernel Patterns Hands-On](../kernel-opt/hands-on/fused-kernel-patterns.md) -- A systematic methodology for kernel fusion
