...
- [Triton Grouped GEMM / DeepGEMM in Practice](../kernel-opt/hands-on/grouped-gemm-deepgemm.md) — GEMM optimization at the Triton level
- [Triton Memory Access Optimization Patterns](../kernel-opt/hands-on/memory-access-optimization.md) — General techniques such as coalesced access and vectorization
- [Persistent Kernel and Tile Scheduling](../kernel-opt/hands-on/persistent-kernel-tile-scheduling.md) — Scheduling strategies such as Stream-K
- [NVIDIA General Optimization Documentation](../../nvidia/) — NCU profiling, async copy, TMA, etc.
- [Blackwell GEMM Optimization in Practice](../../nvidia/blackwell/kernel-opt/hands-on) — Tensor Core optimization on SM100 architecture
- [Hopper GEMM Optimization in Practice](../../nvidia/hopper/kernel-opt/hands-on) — TMA, WGMMA, warp specialization
