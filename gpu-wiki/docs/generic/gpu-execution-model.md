...
- **NVIDIA Specific**: [NVIDIA Compute Capability Reference Table](../nvidia/common/nvidia-compute-capabilities.md) — Specific warp/block/SM limits for each CC
- **AMD Specific**: [Occupancy Optimization](../amd/common/occupancy-optimization.md) — AMD VGPR→occupancy mapping table
