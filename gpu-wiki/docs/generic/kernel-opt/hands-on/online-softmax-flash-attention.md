...
- **Prerequisites**: [GPU Memory Hierarchy](../../ref-docs/gpu-memory-hierarchy.md) — HBM bandwidth bottleneck as the motivation for Flash Attention optimization
- **Hopper Practical Guide**: [Hopper Optimization Guide](README.md) — Flash Attention implementation on SM90
- **AMD Practical Guide**: [AMD Optimization Guide](../../../amd/README.md) — Flash Attention implementation on AMD
