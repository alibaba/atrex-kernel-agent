...
- **Prerequisite Knowledge**: [GPU Memory Hierarchy](../gpu-memory-hierarchy.md) — understand the bandwidth differences between register vs shared memory vs HBM
- **Prerequisite Knowledge**: [GPU Instruction-Level Optimization](../gpu-instruction-optimization.md) — arithmetic instruction throughput
