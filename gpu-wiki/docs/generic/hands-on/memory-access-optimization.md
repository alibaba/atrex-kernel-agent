...
- **Prerequisites**: [GPU Memory Hierarchy](../gpu-memory-hierarchy.md) — Shared memory, coalescing, and vectorized load basics
- **Prerequisites**: [GPU Execution Model](../gpu-execution-model.md) — Warp-level coalesced access
