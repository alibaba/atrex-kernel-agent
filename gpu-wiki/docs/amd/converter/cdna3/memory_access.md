...
- [CDNA3 Layout Mapping (Triton → Gluon)](layouts.md)
- [Matrix Multiplication Patterns](matrix_multiply.md)
- [Memory Access Patterns](../cdna4/memory_access.md)
- [Memory Access Patterns (NVIDIA Hopper)](../../../nvidia/hopper/converter/hopper/memory_access.md)
