# CDNA3 Layout Mapping (Triton → Gluon)

Mapping Triton tensor layouts to Gluon layouts on AMD CDNA3 (gfx942), extracted from TTGIR rather than hand-written.
...
- [API Reference Table](api_mapping.md)
- [Common Errors and Solutions](common_pitfalls.md)
- [Triton → Gluon Conversion Guide (AMD CDNA3)](conversion-guide.md)
- [Matrix Multiplication Patterns](matrix_multiply.md)
- [Memory Access Patterns](memory_access.md)
- [CDNA4 Layout Mapping (Triton → Gluon)](../cdna4/layouts.md)
- [Hopper Layout Mapping (Triton → Gluon)](../../../nvidia/hopper/converter/hopper/layouts.md)
