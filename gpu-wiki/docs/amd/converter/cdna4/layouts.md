# CDNA4 Layout Mapping (Triton → Gluon)

Mapping Triton tensor layouts to Gluon layouts on AMD CDNA4 (gfx950), extracted from TTGIR rather than hand-written.
...
- [CDNA3 Layout Mapping (Triton → Gluon)](../cdna3/layouts.md)
