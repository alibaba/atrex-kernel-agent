...
- **Occupancy**: [Occupancy Optimization](../kernel-opt/occupancy-optimization.md) — Relationship between VGPR and occupancy
- **LDS**: [LDS Bank Conflict Optimization](../kernel-opt/lds-bank-conflict-optimization.md) — Impact of different bank counts on optimization strategies
- **CDNA3 Detailed Specs**: [CDNA3 Hardware Compute Specification Table](../../cdna3/mi300x/hardware-specs/hardware_specs_mi300x.md)
- **CDNA4 Detailed Specs**: [CDNA4 Hardware Compute Specification Table](../../cdna4/hardware-specs/hardware_specs_mi355x.md)
- **Cross-Architecture Compilation**: [Cross-Architecture Conditional Compilation](../kernel-opt/hands-on/cross-architecture-conditional-compilation.md) — Adapting a single kernel to three architectures
