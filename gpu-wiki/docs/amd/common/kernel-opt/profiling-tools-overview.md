...
- **rocprofv3 Details**: [AMD rocprofv3 Profiling Guide](../ref-docs/rocprofv3-profiling-guide.md) — Detailed guide on general rocprofv3 usage
- **CDNA3 Profiling**: [rocprofv3 Instruction-Level Profile Details](../../cdna3/ref-docs/gluon/profiling_guide.md) — ATT hotspot analysis
- **CDNA4 Profiling**: [ROCm Profiling Guide (CDNA4)](../../cdna4/ref-docs/gluon/profiling_guide.md) — Configuration and usage on CDNA4
- **NVIDIA Comparison**: [NCU Profiling Guide](../../../nvidia/common/ref-docs/ncu-profiling-guide.md) — NVIDIA Nsight Compute profiling
