...
- **General Execution Model**: [GPU Execution Model and Thread Optimization](../../../generic/ref-docs/gpu-execution-model.md) — SIMT execution model, general theory of occupancy optimization
