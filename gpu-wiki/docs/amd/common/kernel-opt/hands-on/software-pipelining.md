...
**Source**: `cdna/flydsl/FlyDSL/`, CDNA3 docs/ docs
...
- **General Execution Model**: [GPU Execution Model and Thread Optimization](../../../../generic/ref-docs/gpu-execution-model.md)
- **CDNA4 FP8 in Practice**: [CDNA4 FP8 GEMM Optimization in Practice](../../../cdna4/ref-docs/cdna4-fp8-gemm-optimization.md)
- **General Triton Patterns**: [Triton Optimization Patterns in Practice](../../../../generic/kernel-opt/hands-on/README.md)
