...
- [LDS Bank Conflict Optimization](lds-bank-conflict-optimization.md) -- Bank architecture and XOR swizzle for conflict elimination
- [Preshuffle B Layout](hands-on/preshuffle-b-layout.md) -- Pre-arranged weight matrix to avoid runtime layout conversion
- [MoE 2-Stage Fusion](hands-on/moe-2stage-fusion.md) -- Expert GEMM + SiLU fusion, mixed precision
...
- [CK Tile Dispatcher and ML-Driven Kernel Selection](ck-dispatcher-kernel-selection.md)
