...
- **NVIDIA counterpart**: [NCU Profiling Guide](../../../nvidia/common/ref-docs/ncu-profiling-guide.md) — Full usage of NVIDIA Nsight Compute
- **CDNA3 Instruction-level Analysis**: [rocprofv3 ATT Detailed Guide](../../cdna3/ref-docs/gluon/profiling_guide.md) — ATT Thread Trace usage
- **CDNA4 Instruction-level Analysis**: [CDNA4 rocprofv3 Profile](../../cdna4/ref-docs/gluon/profiling_guide.md)
