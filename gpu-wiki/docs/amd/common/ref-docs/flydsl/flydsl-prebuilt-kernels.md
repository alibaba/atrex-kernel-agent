...
- [Fused MoE Optimization (FlyDSL)](../../../cdna3/mi308x/kernel-opt/flydsl/cdna3-fused-moe-flydsl.md) — MI300X MoE optimization case study
- [MoE 2-Stage Fusion](../../kernel-opt/hands-on/moe-2stage-fusion.md) — Expert GEMM + SiLU fusion pattern
- [Preshuffle B Layout](../../kernel-opt/hands-on/preshuffle-b-layout.md) — Pre-shuffle weight matrix technique
- [AMD MFMA Matrix Core Programming Guide](../amd-mfma-matrix-cores.md) — MFMA instruction details
