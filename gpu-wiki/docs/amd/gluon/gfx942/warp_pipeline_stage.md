...
- **GEMM Chain Upstream**: [Optimization Strategy](optimization_strategy.md) → This document → [Stopping Conditions](final_config_template.md)
- **Converter Reference**: [CDNA3 Pipeline Conversion](../../converter/cdna3/pipeline.md) — Pipeline code produced by conversion is optimized by this document
