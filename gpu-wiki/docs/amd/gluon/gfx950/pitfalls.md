...
- **Cross-architecture Comparison**: [Hopper Pitfalls](../../../nvidia/hopper/gluon/pitfalls.md) — 11 Hopper-specific pitfalls
- **Referenced By**: [matmul](matmul.md) references #1-5 | [fused_attention](fused_attention.md) references #2,7 | [mla_decode](mla_decode.md) references #2-6
