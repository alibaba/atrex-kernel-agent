...
> For MLA Decode, refer to `docs/amd/cdna4/ref-docs/gluon/mla_decode.md` (with mxfp4 QK and online softmax special handling).
...
- MLA Decode: `docs/amd/cdna4/ref-docs/gluon/mla_decode.md`
