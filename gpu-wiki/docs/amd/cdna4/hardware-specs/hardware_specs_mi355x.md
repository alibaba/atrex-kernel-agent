...
- **Cross-Architecture Comparison**: [CDNA3 Hardware Specs](../../cdna3/mi300x/hardware-specs/hardware_specs_mi300x.md) | [Hopper Hardware Specs](../../../nvidia/hopper/hardware-specs/hardware_specs_hopper.md)
- **Detailed Hardware Comparison**: [CDNA4 FP8 GEMM Optimization Practice](../ref-docs/cdna4-fp8-gemm-optimization.md) — Includes CDNA4 vs CDNA3 hardware difference comparison table
- **Downstream Usage**: [CDNA4 ISA Optimization Checklist](../ref-docs/gluon/common_optimizations.md)
