...
Pitfall notes: `docs/amd/cdna4/pitfalls/flydsl/chunk-gdn-pitfalls.md`
...
---
- [FlyDSL Programming Guide](../../../common/ref-docs/flydsl/flydsl-programming-guide.md)
- [FlyDSL Kernel Authoring](../../../common/ref-docs/flydsl/flydsl-ref-kernel-authoring.md)
- [MFMA Instruction Selection](../../../common/kernel-opt/hands-on/mfma-instruction-selection.md)
...
- [SmemPtr Pitfalls](../../pitfalls/flydsl/chunk-gdn-pitfalls.md)
