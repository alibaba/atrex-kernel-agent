...
- **Cross-architecture Comparison**: [Hopper Pitfalls](../../../../nvidia/hopper/ref-docs/gluon/pitfalls.md) — 11 Hopper-specific pitfalls
- **Referenced By**: [matmul](matmul.md) references #1-5 | [fused_attention](../../kernel-opt/gluon/fused_attention.md) references #2,7 | [mla_decode](mla_decode.md) references #2-6
- **🔴 #7 Conflicts with CDNA3**: [CDNA3 WPS](../../../cdna3/mi308x/ref-docs/gluon/warp_pipeline_stage.md) considers WPS to yield +27%, while #7 in this document finds it is a negative optimization for attention
