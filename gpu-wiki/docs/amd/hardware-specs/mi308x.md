...
- **Same ISA, Larger Config**: [MI300X Hardware Specs](mi300x.md) — Full 8-XCD MI300X specifications
- **Architecture Comparison**: [CDNA3 vs CDNA4 Hardware Comparison](hardware-comparison-cdna3-cdna4.md)
- **Cross-Architecture**: [CDNA4 MI355X Specs](mi355x.md) | [Hopper Specs](../../nvidia/common/hardware-specs/hopper.md)
- **Downstream Consumers**: [ISA Optimization Checklist](../gluon/gfx942/common_optimizations.md) — Roofline calculations require the peak TFLOPS from this document
