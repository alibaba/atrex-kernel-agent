...
- **Cross-Architecture Comparison**: [CDNA3 Hardware Specs](mi300x.md) | [Hopper Hardware Specs](../../nvidia/common/hardware-specs/hopper.md)
- **Detailed Hardware Comparison**: [CDNA4 FP8 GEMM Optimization Practice](../common/gfx950/cdna4-fp8-gemm-optimization.md) — Includes CDNA4 vs CDNA3 hardware difference comparison table
- **Downstream Usage**: [CDNA4 ISA Optimization Checklist](../gluon/gfx950/common_optimizations.md)
