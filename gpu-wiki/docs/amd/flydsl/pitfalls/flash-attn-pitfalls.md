...
`ref-docs/amd/flydsl/gfx942/cdna3-flash-attention-bf16-gqa-optimization.md`.
...
See also: [cdna3-flash-attention-bf16-mask-optimization.md](../gfx942/cdna3-flash-attention-bf16-mask-optimization.md)
...
See also: [cdna3-flash-attention-bf16-gqa-optimization.md](../gfx942/cdna3-flash-attention-bf16-gqa-optimization.md)
...
See also: [cdna3-flash-attention-bf16-mask-optimization.md](../gfx942/cdna3-flash-attention-bf16-mask-optimization.md) V7.
...
See also:
[cdna3-flash-attention-bf16-nomask-isa-scheduling.md](../gfx942/cdna3-flash-attention-bf16-nomask-isa-scheduling.md).
...
- [Pitfalls: FlyDSL Attention Backward dQ + dK+dV on MI308X (gfx942)](attention-backward-dkdv-pitfalls.md)
- [Pitfalls: FlyDSL Chunk-GDN Wave-Specialized Megakernel on MI308X](chunk-gdn-mi308x-wave-specialization-pitfalls.md)
- [Pitfalls: FlyDSL Chunk-GDN on MI355X (gfx950)](chunk-gdn-pitfalls.md)
- [Pitfalls: FlyDSL Flash Attention Backward — Arbitrary Mask Integration on MI308X](flash-attn-bwd-mask-integration-pitfalls.md)
- [Flash Attention head_dim=256 Pitfalls (CDNA4 / gfx950)](flash-attn-d256-pitfalls.md)
- [FlashAttention 1–4: GPU Generational Evolution](../../../nvidia/common/flash-attention-1-to-4-gpu-evolution.md)
