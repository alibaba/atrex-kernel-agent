...
- [AMD GPU Kernel Optimization Framework Overview](../../common/amd-kernel-optimization-frameworks.md) -- FlyDSL's position within the AMD optimization framework
- [AMD MFMA Matrix Core Programming Guide](../../common/amd-mfma-matrix-cores.md) -- MFMA instruction reference used by FlyDSL
