...
- [Fused MoE Optimization (FlyDSL)](gfx942/cdna3-fused-moe-flydsl.md) — MI300X MoE optimization case study
- [MoE 2-Stage Fusion](../common/hands-on/moe-2stage-fusion.md) — Expert GEMM + SiLU fusion pattern
- [Preshuffle B Layout](../common/hands-on/preshuffle-b-layout.md) — Pre-shuffle weight matrix technique
