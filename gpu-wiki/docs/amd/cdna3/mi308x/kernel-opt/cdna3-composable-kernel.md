...
- [AMD GPU Kernel Optimization Frameworks Overview](../../../common/ref-docs/amd-kernel-optimization-frameworks.md) -- CK's position within the AMD optimization framework
- [AMD MFMA Matrix Core Programming Guide](../../../common/ref-docs/amd-mfma-matrix-cores.md) -- MFMA instructions used at the CK low level
