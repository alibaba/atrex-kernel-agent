...
This guide assumes the input code is already a **correctly compiling and runnable Gluon kernel**. If conversion from Triton to Gluon is needed, first use the CDNA3 conversion guidance in `docs/amd/cdna3/conversion-guide.md`.
...
- **Gluon API Reference**: `docs/amd/common/porting_rules.md`
- **Layout Types**: `docs/amd/cdna3/layouts.md`
- **Memory Access Patterns**: `docs/amd/cdna3/memory_access.md`
- **Matrix Multiplication Patterns**: `docs/amd/cdna3/matrix_multiply.md`
- **Pipeline Patterns**: `docs/amd/cdna3/pipeline.md`
...
> For the **complete methodology**, see [AMD GPU Roofline Analysis Methodology](../../../../common/kernel-opt/roofline-analysis-methodology.md), including tile-level AI computation, Ridge Point tables, bottleneck determination rules, and tile size selection decision flow.
...
> For **utilization formulas and peak parameters**, see [AMD GPU Roofline Analysis Methodology §4](../../../../common/kernel-opt/roofline-analysis-methodology.md#4-utilization-assessment).
...
For detailed profile interpretation guide, see `docs/amd/cdna3/ref-docs/gluon/profiling_guide.md` (including complete cleanup strategy).
...
> For general principles, diagnostic methods, and repair strategies, see [Coalesced Memory Access and Load/Store Instruction Width Optimization](../../../../common/kernel-opt/coalesced-access-load-store-width.md).
...
See `docs/amd/cdna3/ref-docs/gluon/common_optimizations.md` § 3.2
...
See `docs/amd/cdna3/ref-docs/gluon/common_optimizations.md` § 3.3

---

### 3.4 Eliminate Scratch Operations (Register Spilling)

> For general principles, VGPR limits, diagnostic methods, and fix strategies, see [Eliminate Scratch Operations (Register Spilling)](../../../../common/kernel-opt/scratch-elimination-vgpr-spill.md), which includes a VGPR budget reference table and num_warps alternatives.
...
| Cause | Fix |
|------|---------|
| Software pipelining not implemented | Implement a three-stage pipeline (prologue + main loop + epilogue), see `docs/amd/cdna3/pipeline.md` |
...
See `docs/amd/cdna3/ref-docs/gluon/common_optimizations.md` § 3.5
...
See `docs/amd/cdna3/ref-docs/gluon/common_optimizations.md` § 3.6.
...
See `docs/amd/cdna3/mi308x/ref-docs/gluon/warp_pipeline_stage.md` for details.
...
See `docs/amd/cdna3/mi308x/ref-docs/gluon/warp_pipeline_stage.md` and `pattern_overview.md` (pitfalls 12-15) for details.
...
> **Complete optimization strategy** is detailed in [Small Matrix / Low CU Utilization Optimization](../../../../common/kernel-opt/small-matrix-cu-utilization.md), including reducing tile size to increase grid parallelism (measured 2.5-2.85× improvement), increasing BLOCK_SIZE_K, ISA micro-optimizations, and inapplicable optimization lists.
...
For details, see `optimization_strategy.md` and `docs/amd/cdna3/mi308x/ref-docs/gluon/key_conclusions.md`
...
| Document | Content |
|------|------|
| `docs/amd/cdna3/mi308x/hardware-specs/hardware_specs_mi308x.md` | AMD GPU Hardware Compute Specification Sheet |
| `docs/amd/cdna3/ref-docs/gluon/profiling_guide.md` | rocprofv3 Instruction-Level Profiling Detailed Guide |
| `docs/amd/cdna3/ref-docs/gluon/common_optimizations.md` | General ISA Optimization Checklist (§3.0-§3.5, applicable to all AMD CDNA3 kernels) |
| `docs/amd/cdna3/ref-docs/gluon/` | Standard GEMM Optimization Topic (WPS pipeline, final configuration template, pitfalls 7-23, 44-59) |
| `docs/amd/cdna3/ref-docs/gluon/` | Small Matrix GEMM Optimization Topic (Tile size search, pitfalls 32-37, 41-43) |
| `docs/amd/cdna3/ref-docs/gluon/` | Flash Attention Optimization Topic (SE-level zigzag, anti-patterns, pitfalls 24-31, 38-40) |
| `docs/amd/cdna3/ref-docs/gluon/isa_patterns.md` | CDNA3 ISA Instruction Patterns and Optimization Reference |
| `docs/amd/cdna3/mi308x/ref-docs/gluon/ck_gemm_optimization_reference.md` | CK Optimization Technology Reference |
| `docs/amd/cdna3/ref-docs/gluon/gluon-amd-gfx942-optimization.md` | Gluon AMD API Feature and Optimization Technology Reference |

### Cross-Reference (docs/ guide)

| Document | Referenced Content |
|------|---------|
| `docs/amd/common/porting_rules.md` | Gluon Complete API Reference |
| `docs/amd/cdna3/layouts.md` | AMD Layout Types and TTGIR Mapping |
| `docs/amd/cdna3/pipeline.md` | AMD Pipeline Implementation Patterns |
| `docs/amd/cdna3/memory_access.md` | AMD Memory Access Patterns |
| `docs/amd/cdna3/common_pitfalls.md` | AMD Common Pitfalls and Solutions |
