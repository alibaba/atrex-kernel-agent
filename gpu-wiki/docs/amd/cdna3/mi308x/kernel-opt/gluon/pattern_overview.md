...
> This document is a specialized scenario of `matmul`. For general GEMM optimization, see `docs/amd/cdna3/mi308x/ref-docs/gluon/warp_pipeline_stage.md` and the general ISA checklist in `common_optimizations.md`.
