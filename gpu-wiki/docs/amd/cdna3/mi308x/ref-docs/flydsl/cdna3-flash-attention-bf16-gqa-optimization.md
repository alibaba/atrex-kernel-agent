...
Companion debugging notes are in `docs/amd/cdna3/mi308x/pitfalls/flydsl/flash-attn-pitfalls.md`.
...
See `docs/amd/cdna3/mi308x/pitfalls/flydsl/flash-attn-pitfalls.md` for the full debugging
trail.
...
See `docs/amd/cdna3/mi308x/pitfalls/flydsl/flash-attn-pitfalls.md` traps 18–22 for details.
...
- Companion pitfalls: `docs/amd/cdna3/mi308x/pitfalls/flydsl/flash-attn-pitfalls.md`
- FP8 sibling: `cdna3-sage-attention-flydsl-optimization.md`
- LDS bank conflicts: `docs/amd/common/kernel-opt/lds-bank-conflict-optimization.md`
