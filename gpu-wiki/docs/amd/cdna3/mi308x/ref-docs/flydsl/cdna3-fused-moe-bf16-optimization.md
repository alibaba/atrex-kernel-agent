...
- [Fused MoE Optimization (W4A16)](../../kernel-opt/flydsl/cdna3-fused-moe-flydsl.md) — Kimi-K2.5 W4A16 mixed-precision MoE optimization
- [FlyDSL Programming Guide](../../../../common/ref-docs/flydsl/flydsl-programming-guide.md) — FlyDSL programming guide
- [AMD MFMA Matrix Core Programming Guide](../../../../common/ref-docs/amd-mfma-matrix-cores.md) — MFMA instruction reference
