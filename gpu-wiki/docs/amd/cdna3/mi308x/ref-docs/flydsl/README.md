# amd/cdna3/mi308x/ref-docs/flydsl
...
- [FlyDSL Flash Attention Forward (fp16, no-mask) on MI308X](cdna3-flash-attention-fp16-nomask-ck-isa-optimization.md)
- [FlyDSL Flash Attention Backward bf16 — Arbitrary Mask Integration on MI308X (gfx942)](cdna3-flash-attn-bwd-bf16-arbitrary-mask-integration.md)
- [FlyDSL Fused MoE BF16 Step-by-Step Optimization (MI308X gfx942)](cdna3-fused-moe-bf16-optimization.md)
- [FlyDSL Fused MoE FP8 PTPC atrex-open v2 on MI308X](cdna3-fused-moe-fp8-ptpc-atrex-v2.md)
- [FlyDSL Fused MoE FP8 PTPC Pause Checkpoint on MI308X](cdna3-fused-moe-fp8-ptpc-pause-checkpoint.md)
- [FlyDSL SageAttention Step-by-Step Optimization Practice (MI308X gfx942)](cdna3-sage-attention-flydsl-optimization.md)
