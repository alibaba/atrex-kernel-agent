...
See `docs/amd/cdna3/pipeline.md` for details.
...
- **Prerequisites**: [CDNA3 Hardware Specifications](../../mi300x/hardware-specs/hardware_specs_mi300x.md) — Required for Roofline analysis
- **Cross-Architecture Reference**: [CDNA4 ISA Optimization Checklist](../../../cdna4/ref-docs/gluon/common_optimizations.md) | [Hopper ISA Optimization Checklist](../../../../nvidia/hopper/ref-docs/gluon/common_optimizations.md)
...
- **🔴 Conflict Note**: This document considers manual ISA optimization to be effective (+1-4%), but [Hopper pitfalls #1](../../../../nvidia/hopper/ref-docs/gluon/pitfalls.md) found that manual refactoring on sm_90 is almost always a negative optimization
