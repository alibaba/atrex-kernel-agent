...
- **General rocprofv3 Usage**: [AMD rocprofv3 Profiling Guide](../../../common/ref-docs/rocprofv3-profiling-guide.md) — general features such as tracing, counter collection, output formats
