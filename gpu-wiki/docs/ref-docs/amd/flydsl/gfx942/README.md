...
| [cdna3-fused-moe-fp8-ptpc-pause-checkpoint.md](cdna3-fused-moe-fp8-ptpc-pause-checkpoint.md) | FlyDSL Fused MoE FP8 PTPC pause checkpoint on MI308X; E=512/topk=10/task66 source state, 1/14 rows passing, invalid evidence boundaries, and continuation recipe |
| [cdna3-fused-moe-fp8-ptpc-atrex-v2.md](cdna3-fused-moe-fp8-ptpc-atrex-v2.md) | atrex-open integrated FlyDSL FP8 PTPC Fused MoE v2 full-pipeline archive; same-machine profile parity against atrex-open v2 and trace guard for routing/memcpy/other buckets |
...
| [cdna3-chunk-gdn-mi308x-wave-specialized-megakernel-optimization.md](cdna3-chunk-gdn-mi308x-wave-specialized-megakernel-optimization.md) | FlyDSL Chunk-GDN wave-specialized megakernel on MI308X; ported FlashQLA warp-specialization approach, fused `recompute_w_u + fwd_h + fwd_o` back half; standalone 397B-TP2 back-half relative to Triton comparison baseline `1.644-1.720x` |
