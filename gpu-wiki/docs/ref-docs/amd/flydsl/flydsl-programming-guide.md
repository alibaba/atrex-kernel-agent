...
- [AMD GPU Kernel Optimization Framework Overview](../common/amd-kernel-optimization-frameworks.md) — FlyDSL's positioning within the framework lineage
- [Fused MoE Optimization (FlyDSL)](../../../kernel-opt/amd/flydsl/gfx942/cdna3-fused-moe-flydsl.md) — MoE optimization case study on MI300X
- [AMD MFMA Matrix Core Programming Guide](../common/amd-mfma-matrix-cores.md) — Detailed reference for MFMA instructions
