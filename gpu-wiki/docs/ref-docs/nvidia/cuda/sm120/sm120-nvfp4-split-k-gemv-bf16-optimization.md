...
- Pitfalls: [nvfp4-split-k-gemv-pitfalls.md](../../../../pitfalls/nvidia/cuda/nvfp4-split-k-gemv-pitfalls.md)
- CUTLASS scheduling background: [cutlass-tile-scheduling.md](../../cutedsl/cutlass-tile-scheduling.md)
- NCU estimate meta-rule: [ncu-rule-est-speedup-meta-rules.md](../../common/ncu-rule-est-speedup-meta-rules.md)
