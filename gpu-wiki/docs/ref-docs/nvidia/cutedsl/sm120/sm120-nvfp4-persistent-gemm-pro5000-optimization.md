...
[docs/pitfalls/nvidia/cutedsl/nvfp4-gemm-pitfalls.md](../../../../pitfalls/nvidia/cutedsl/nvfp4-gemm-pitfalls.md).
...
5. **Always re-issue `cute.recast_tensor` inside the dynamic K-loop**, never above. See
   [pitfalls](../../../../pitfalls/nvidia/cutedsl/nvfp4-gemm-pitfalls.md#1-recast-views-must-be-inside-the-dynamic-loop).
...
- Block-scaled background:
  [cutlass-quantization-block-scaled.md](../cutlass-quantization-block-scaled.md)
- cute-DSL pipeline + inline-PTX docs:
  [cutedsl-pipeline-patterns.md](../cutedsl-pipeline-patterns.md),
  [cutedsl-inline-ptx-patterns.md](../cutedsl-inline-ptx-patterns.md)
