...
- [Profiling Tools by Architecture](../../../kernel-opt/nvidia/common/profiling-tools-by-arch.md) — Profiling tool support for different GPU architectures
- [Occupancy Tuning](../../../kernel-opt/nvidia/common/occupancy-tuning-by-arch.md) — Occupancy calculation and tuning strategies by architecture
- [NVIDIA Compute Capabilities](../../../kernel-opt/nvidia/common/nvidia-compute-capabilities.md) — SM resource limits (registers/shared memory/warp count)
