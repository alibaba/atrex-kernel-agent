...
A synthesis of kernel optimization insights on Hopper (SM90) and Blackwell (SM100) architectures from Zhihu community. Supplements the hands-on documentation in [sm90/hands-on/](../../../../kernel-opt/generic/hands-on).
...
- [Hopper SM90 Optimization Practices](../../../../kernel-opt/generic/hands-on) — 13 practical documents covering TMA, WGMMA, mbarrier pipeline, warp specialization, and more
- [Blackwell SM100 Optimization Practices](../../../../kernel-opt/generic/hands-on) — 11 practical documents covering tcgen05/TMEM, three-role warp specialization, CLC, 2CTA, and more
