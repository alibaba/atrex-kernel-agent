...
- [Architecture Profiling Tools](../../../kernel-opt/nvidia/common/profiling-tools-by-arch.md) — nsys/ncu support per architecture
- [Occupancy Tuning](../../../kernel-opt/nvidia/common/occupancy-tuning-by-arch.md) — Occupancy calculation and tuning strategies
- [NVIDIA Compute Capabilities](../../../kernel-opt/nvidia/common/nvidia-compute-capabilities.md) — Hardware resource limits per architecture
- [NVIDIA Architecture-Specific Optimization](../../../kernel-opt/nvidia/common/nvidia-arch-specific-optimization.md) — Optimization features per architecture generation
- [L2 Cache Persistence](../../../kernel-opt/nvidia/common/l2-cache-persistence.md) — L2 Persistence configuration
