...
- **Prerequisites**: [GPU Memory Hierarchy](../../../ref-docs/generic/gpu-memory-hierarchy.md) — Shared memory, coalescing, and vectorized load basics
- **Prerequisites**: [GPU Execution Model](../../../ref-docs/generic/gpu-execution-model.md) — Warp-level coalesced access
