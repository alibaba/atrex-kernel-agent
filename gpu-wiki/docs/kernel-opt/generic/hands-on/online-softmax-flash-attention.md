...
- **Prerequisites**: [GPU Memory Hierarchy](../../../ref-docs/generic/gpu-memory-hierarchy.md) — HBM bandwidth bottleneck as the motivation for Flash Attention optimization
