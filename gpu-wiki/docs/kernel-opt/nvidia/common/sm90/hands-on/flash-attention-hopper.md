...
- **Fused Attention Topic**: [Hopper Fused Attention Optimization](../../../gluon/sm90/fused_attention.md) — prefill / paged attention
- **General Triton Patterns**: [Triton Optimization Patterns in Practice](../../../../generic/hands-on/README.md) — Flash Attention basics
- **CuTeDSL SM90**: [CuTeDSL SM90 Specialized Features](../../../../../ref-docs/nvidia/cutedsl/sm90/hopper-cutedsl-sm90.md) — WGMMA details
