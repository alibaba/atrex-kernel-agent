...
- **CuTeDSL Pipeline**: [CuTeDSL Software Pipeline and Synchronization Patterns](../../../../../ref-docs/nvidia/cutedsl/cutedsl-pipeline-patterns.md) — producer/consumer state machine
- **PTX Synchronization**: [PTX Synchronization and Async Operations](../../../../../ref-docs/nvidia/common/nvidia-ptx-sync-and-async.md) — mbarrier details
- **Hardware Specifications**: [Hopper Hardware Specifications Table](../../../../../hardware-specs/hardware_specs_hopper.md) — shared memory capacity
