...
- [PTX Synchronization and Async Operations](../../../ref-docs/nvidia/common/nvidia-ptx-sync-and-async.md) — Details on async copy instructions at the PTX level
- [CuTeDSL Software Pipelining and Synchronization Patterns](../../../ref-docs/nvidia/cutedsl/cutedsl-pipeline-patterns.md) — Pipeline abstractions in the upper-level DSL
- [GPU Memory Hierarchy and Optimization](../../../ref-docs/generic/gpu-memory-hierarchy.md) — General principles of shared memory optimization
