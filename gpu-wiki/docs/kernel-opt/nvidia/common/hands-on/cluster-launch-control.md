...
- **Generic Triton**: [Triton Optimization Patterns in Practice](../../../generic/hands-on/README.md) — persistent kernel pattern
- **CuTeDSL Basics**: [CuTeDSL Programming Model](../../../../ref-docs/nvidia/cutedsl/cutedsl-programming-model.md) — Python DSL compilation pipeline
