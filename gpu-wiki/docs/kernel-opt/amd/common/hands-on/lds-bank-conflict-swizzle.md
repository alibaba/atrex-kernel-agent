...
- **Profiling**: [AMD rocprofv3 Profiling Guide](../../../../ref-docs/amd/common/rocprofv3-profiling-guide.md) — General rocprofv3 usage
- **General Memory Hierarchy**: [GPU Memory Hierarchy and Optimization](../../../../ref-docs/generic/gpu-memory-hierarchy.md)
