...
- [AMD GPU Kernel Optimization Frameworks Overview](../../../../ref-docs/amd/common/amd-kernel-optimization-frameworks.md) -- CK's position within the AMD optimization framework
- [AMD MFMA Matrix Core Programming Guide](../../../../ref-docs/amd/common/amd-mfma-matrix-cores.md) -- MFMA instructions used at the CK low level
