...
- `Est. Speedup %` is a ceiling, not a wall-time delta:
  [`../../../ref-docs/nvidia/common/ncu-rule-est-speedup-meta-rules.md`](../../../ref-docs/nvidia/common/ncu-rule-est-speedup-meta-rules.md)
...
- Blackwell kernel knowledge (split-K, flash-decode, sparse MLA):
  [`../../../kernel-opt/nvidia/common/blackwell/`](../../../kernel-opt/nvidia/common/blackwell/)
