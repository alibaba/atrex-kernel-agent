...
| [fused-moe-fp8-ptpc-pitfalls.md](fused-moe-fp8-ptpc-pitfalls.md) | FP8 PTPC Fused MoE task66 checkpoint plus atrex-open v2 full-pipeline migration: invalid references, target_us timing-source drift, skip-atomic/no-output diagnostics, `block_m=8`, rowctx/rowinfo-LDS non-promotions, host-sync-free valid-block policy, M=1 stream boundary, routing reuse, M=1 event jitter | MI308X (gfx942) | 11 |
...
- [cdna3-fused-moe-fp8-ptpc-pause-checkpoint.md](../../../ref-docs/amd/flydsl/gfx942/cdna3-fused-moe-fp8-ptpc-pause-checkpoint.md)
- [cdna3-fused-moe-fp8-ptpc-atrex-v2.md](../../../ref-docs/amd/flydsl/gfx942/cdna3-fused-moe-fp8-ptpc-atrex-v2.md)
