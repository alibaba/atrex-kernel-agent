...
Full journey: [`../../../ref-docs/nvidia/cutedsl/sm120/sm120-moe-data-prep-optimization.md`](sm120-moe-data-prep-optimization.md).
...
Cautionary patterns: [`../../../pitfalls/nvidia/cutedsl/sm120-moe-data-prep-pitfalls.md`](pitfalls/sm120-moe-data-prep-pitfalls.md).
...
| Trust NCU "% est. speedup" as wall-time delta when 3+ stalls each > 30% CPI | Multi-bottleneck rebalances rather than reduces wall time. See [cross-arch meta-rule](../../common/profiling/ncu-rule-est-speedup-meta-rules.md). |
...
- Optimization journey (V0..V11): [`../../../ref-docs/nvidia/cutedsl/sm120/sm120-moe-data-prep-optimization.md`](sm120-moe-data-prep-optimization.md)
- Pitfalls (4 traps): [`../../../pitfalls/nvidia/cutedsl/sm120-moe-data-prep-pitfalls.md`](pitfalls/sm120-moe-data-prep-pitfalls.md)
- Cross-arch NCU rebalancing meta-rule: [`../../../ref-docs/nvidia/common/ncu-rule-est-speedup-meta-rules.md`](../../common/profiling/ncu-rule-est-speedup-meta-rules.md)
- Sister sm_120 quick-references:
  ...
  - NVFP4 inline-PTX GEMM: [`sm120-nvfp4-inline-ptx-gemm.md`](sm120-nvfp4-inline-ptx-gemm.md)
