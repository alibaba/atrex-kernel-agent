...
Vendoring flash_attn.cute into a cutlass 4.4.2 environment triggers cascading ImportErrors from private-name renames with no convergent fix path.
...
- `docs/pitfalls/nvidia/cutedsl/nvfp4-gemm-pitfalls.md` — sm_120 cute 4.4.2 traps already documented (this would be a sister pitfall)
