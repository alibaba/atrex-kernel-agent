...
vLLM's vendored flash attention falls back to a generic slow path on sm_120, causing unexpected performance regression.
...
- `docs/ref-docs/nvidia/cutedsl/sm120/sm120-gdn-decode-fp32state-bf16qkv-optimization.md` — sm_120 memory-bound kernel that DOES hit the ceiling (proves the hardware can; it's a software gap)
