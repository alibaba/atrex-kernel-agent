...
[docs/pitfalls/nvidia/cutedsl/nvfp4-gemm-pitfalls.md](pitfalls/nvfp4-gemm-pitfalls.md).
...
5. **Always re-issue `cute.recast_tensor` inside the dynamic K-loop**, never above. See
   [pitfalls](pitfalls/nvfp4-gemm-pitfalls.md#1-recast-views-must-be-inside-the-dynamic-loop).
...
- Atom-level inline-PTX demo + register packing convention:
  [docs/ref-docs/nvidia/cutedsl/sm120/sm120-nvfp4-inline-ptx-gemm.md](sm120-nvfp4-inline-ptx-gemm.md)
...
- Block-scaled background:
  [cutlass-quantization-block-scaled.md](../../common/cutedsl/cutlass-quantization-block-scaled.md)
- cute-DSL pipeline + inline-PTX docs:
  [cutedsl-pipeline-patterns.md](../../common/cutedsl/cutedsl-pipeline-patterns.md),
  [cutedsl-inline-ptx-patterns.md](../../common/cutedsl/cutedsl-inline-ptx-patterns.md)
