...
- `docs/nvidia/blackwell-geforce/pitfalls/cutedsl/sm120-{ncu-l1-hit-rate-includes-shared, tma-warp-spec-pitfalls, flash-attn-vllm-no-fast-path, cutedsl-vendor-pitfalls}.md` (4 pitfalls)
- `docs/nvidia/blackwell-geforce/ref-docs/cutedsl/sm120-fp4-quant-epilogue-stage3-closeout.md` (this file, renamed)
- `docs/nvidia/blackwell-geforce/ref-docs/cutedsl/v3-fa-fusion-deferred-plan.md` (or under `docs/work-in-progress/` if such a dir exists)
- `docs/nvidia/blackwell-geforce/ref-docs/cutedsl/sm120-pipeline-tma-async-api-notes.md` (API reference + (D) deferred plan)
