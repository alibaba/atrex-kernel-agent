...
- **Pitfalls** (the 9+ traps from this 18-version journey):
  [`docs/nvidia/blackwell-geforce/pitfalls/cutedsl/gdn-decode-pitfalls.md`](../../pitfalls/cutedsl/gdn-decode-pitfalls.md)
...
- **Latency-bound recurrence framework** (T>1 chunked variants):
  [`docs/nvidia/hopper/ref-docs/gluon/linear_attention.md`](../../../hopper/ref-docs/gluon/linear_attention.md)
- **CuTeDSL programming model** prerequisites:
  [`docs/nvidia/common/ref-docs/cutedsl/cutedsl-programming-model.md`](../../../common/ref-docs/cutedsl/cutedsl-programming-model.md),
  [`docs/nvidia/common/ref-docs/cutedsl/cutedsl-pipeline-patterns.md`](../../../common/ref-docs/cutedsl/cutedsl-pipeline-patterns.md)
