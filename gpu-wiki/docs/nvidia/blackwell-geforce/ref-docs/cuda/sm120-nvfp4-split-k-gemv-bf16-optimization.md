...
- Pitfalls: [nvfp4-split-k-gemv-pitfalls.md](../../pitfalls/cuda/nvfp4-split-k-gemv-pitfalls.md)
- CUTLASS scheduling background: [cutlass-tile-scheduling.md](../../../common/ref-docs/cutedsl/cutlass-tile-scheduling.md)
- NCU estimate meta-rule: [ncu-rule-est-speedup-meta-rules.md](../../../common/ref-docs/ncu-rule-est-speedup-meta-rules.md)
