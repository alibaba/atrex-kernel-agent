...
Full journey: [`docs/nvidia/blackwell-geforce/ref-docs/cutedsl/sm120-moe-data-prep-optimization.md`](../../ref-docs/cutedsl/sm120-moe-data-prep-optimization.md).
...
Cautionary patterns: [`docs/nvidia/blackwell-geforce/pitfalls/cutedsl/sm120-moe-data-prep-pitfalls.md`](../../pitfalls/cutedsl/sm120-moe-data-prep-pitfalls.md).
...
| Trust NCU "% est. speedup" as wall-time delta when 3+ stalls each > 30% CPI | Multi-bottleneck rebalances rather than reduces wall time. See [cross-arch meta-rule](../../../common/ref-docs/ncu-rule-est-speedup-meta-rules.md). |
...
- Optimization journey (V0..V11): [`docs/nvidia/blackwell-geforce/ref-docs/cutedsl/sm120-moe-data-prep-optimization.md`](../../ref-docs/cutedsl/sm120-moe-data-prep-optimization.md)
- Pitfalls (4 traps): [`docs/nvidia/blackwell-geforce/pitfalls/cutedsl/sm120-moe-data-prep-pitfalls.md`](../../pitfalls/cutedsl/sm120-moe-data-prep-pitfalls.md)
- Cross-arch NCU rebalancing meta-rule: [`docs/nvidia/common/ref-docs/ncu-rule-est-speedup-meta-rules.md`](../../../common/ref-docs/ncu-rule-est-speedup-meta-rules.md)
- Sister sm_120 quick-references:
  ...
  - NVFP4 inline-PTX GEMM: [`sm120-nvfp4-inline-ptx-gemm.md`](../../ref-docs/cutedsl/sm120-nvfp4-inline-ptx-gemm.md)
