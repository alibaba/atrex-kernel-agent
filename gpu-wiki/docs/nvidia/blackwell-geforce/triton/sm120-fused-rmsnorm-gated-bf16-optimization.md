...
- Lesson: hints can be necessary-but-not-sufficient. See pitfalls
  [#1](pitfalls/sm120-fused-rmsnorm-gated-pitfalls.md#1-cachemodifiercg-ldg128-hints-can-land-in-ptx-with-zero-performance-gain).
...
- **Pitfalls**: [`docs/pitfalls/nvidia/triton/sm120-fused-rmsnorm-gated-pitfalls.md`](pitfalls/sm120-fused-rmsnorm-gated-pitfalls.md)
...
- **sm_120 cp.async / cache mode (CuTeDSL specific)**:
  [`sm120-gdn-decode-cpasync-cache-mode.md`](../cutedsl/sm120-gdn-decode-cpasync-cache-mode.md)
- **NVIDIA `ncu` profiling**: [`ncu-profiling-guide.md`](../../common/profiling/ncu-profiling-guide.md)
