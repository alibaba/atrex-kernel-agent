...
[`docs/ref-docs/nvidia/triton/sm120/sm120-fused-rmsnorm-gated-bf16-optimization.md`](../sm120-fused-rmsnorm-gated-bf16-optimization.md)
...
- Optimisation report (full V1 → V3 journey):
  [`sm120-fused-rmsnorm-gated-bf16-optimization.md`](../sm120-fused-rmsnorm-gated-bf16-optimization.md)
- Final kernel source:
...
- Adjacent CuTeDSL pitfalls on the same sm_120 hardware (different DSL,
  ...
  [`docs/pitfalls/nvidia/cutedsl/`](../../cutedsl/pitfalls/README.md) — especially
