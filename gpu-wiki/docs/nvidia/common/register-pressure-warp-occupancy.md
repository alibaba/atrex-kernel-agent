...
> Related Documents: [Occupancy Tuning](occupancy-tuning-by-arch.md) | [Warp Specialization Design Principles](warp-specialization-design-principles.md) | [PTX Synchronization and Asynchronous Operations](ptx/nvidia-ptx-sync-and-async.md)
...
- Occupancy differences across architectures: [Occupancy Tuning](occupancy-tuning-by-arch.md)
- NCU performance analysis: [NCU Profiling Guide](profiling/ncu-profiling-guide.md)
...
- [Warp Specialization Design Principles](warp-specialization-design-principles.md)
- [Occupancy Optimization](../../amd/common/occupancy-optimization.md)
- [Occupancy Tuning Differences Across Architectures](occupancy-tuning-by-arch.md)
