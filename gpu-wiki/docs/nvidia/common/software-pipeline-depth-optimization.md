...
- [Async Copy and Synchronization Primitives](ptx/nvidia-ptx-sync-and-async.md) — Synchronization details for mbarrier, cp.async, and TMA
...
- [L2 Cache Persistence](l2-cache-persistence.md) — Global memory access optimization
