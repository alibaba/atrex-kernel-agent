...
- **Cross-Architecture Comparison**: [CDNA3 Hardware Specs](../../../amd/hardware-specs/mi300x.md) | [CDNA4 Hardware Specs](../../../amd/hardware-specs/mi355x.md)
- **General Spec Tables**: [NVIDIA Compute Capability Reference Table](../nvidia-compute-capabilities.md)
- **Downstream Consumption**: [Hopper ISA Optimization Checklist](../../hopper/gluon/common_optimizations.md)
