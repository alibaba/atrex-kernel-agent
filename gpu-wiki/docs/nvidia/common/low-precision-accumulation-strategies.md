...
- [L2 Cache Persistence](l2-cache-persistence.md) — L2 cache persistence, which affects cache hits for quantized weights
- [Occupancy Tuning](occupancy-tuning-by-arch.md) — promotion increases register pressure, affecting occupancy
