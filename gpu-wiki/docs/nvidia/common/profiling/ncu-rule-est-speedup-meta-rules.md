...
- `assumed_align=16` to unlock cp.async cp_size=128b (single-line fix; ~50% wins
  on streaming workloads — see [`../cutedsl/sm120-gdn-decode-fp32state-bf16qkv-optimization.md`](../../blackwell-geforce/cutedsl/sm120-gdn-decode-fp32state-bf16qkv-optimization.md))
...
Full case study:
- Pitfalls: [`../../pitfalls/nvidia/cutedsl/sm120-moe-data-prep-pitfalls.md`](../../blackwell-geforce/cutedsl/pitfalls/sm120-moe-data-prep-pitfalls.md)
- Optimization journey: [`../cutedsl/sm120/sm120-moe-data-prep-optimization.md`](../../blackwell-geforce/cutedsl/sm120-moe-data-prep-optimization.md)
