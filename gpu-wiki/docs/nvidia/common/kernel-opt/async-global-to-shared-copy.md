...
- [PTX Synchronization and Async Operations](../ref-docs/nvidia-ptx-sync-and-async.md) — Details on async copy instructions at the PTX level
- [CuTeDSL Software Pipelining and Synchronization Patterns](../ref-docs/cutedsl/cutedsl-pipeline-patterns.md) — Pipeline abstractions in the upper-level DSL
- [GPU Memory Hierarchy and Optimization](../../../generic/ref-docs/gpu-memory-hierarchy.md) — General principles of shared memory optimization
