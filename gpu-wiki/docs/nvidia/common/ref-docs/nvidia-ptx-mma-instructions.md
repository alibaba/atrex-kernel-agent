...
- **AMD Counterpart**: [AMD MFMA Matrix Core Programming Guide](../../../amd/common/ref-docs/amd-mfma-matrix-cores.md) — AMD matrix core instructions
- **CuTeDSL Wrapper**: [CuTeDSL SM90 Special Features](../../hopper/ref-docs/cutedsl/hopper-cutedsl-sm90.md) — High-level DSL wrapper for wgmma
