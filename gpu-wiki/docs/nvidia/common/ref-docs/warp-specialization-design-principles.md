...
> Related documentation: [PTX Synchronization and Asynchronous Operations](nvidia-ptx-sync-and-async.md) | [Occupancy Tuning](../kernel-opt/occupancy-tuning-by-arch.md) | [Register Pressure and Occupancy](register-pressure-warp-occupancy.md)
...
- Hopper Pingpong in Practice: `docs/nvidia/hopper/kernel-opt/hands-on/` directory
- Blackwell Tri-Role in Practice: `docs/nvidia/blackwell/kernel-opt/hands-on/` directory
