...
- [L2 Cache Persistence](../kernel-opt/l2-cache-persistence.md) — L2 set-aside strategy, complementary to swizzle
- [Occupancy Tuning](../kernel-opt/occupancy-tuning-by-arch.md) — CTA count selection for persistent kernels
- [Thread Block Cluster](../kernel-opt/thread-block-cluster.md) — Cluster shape affects swizzle granularity
