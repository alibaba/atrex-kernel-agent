...
> Related Documents: [Occupancy Tuning](../kernel-opt/occupancy-tuning-by-arch.md) | [Warp Specialization Design Principles](warp-specialization-design-principles.md) | [PTX Synchronization and Asynchronous Operations](nvidia-ptx-sync-and-async.md)
...
- Occupancy differences across architectures: [Occupancy Tuning](../kernel-opt/occupancy-tuning-by-arch.md)
