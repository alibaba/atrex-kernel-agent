...
> For general hierarchical reduction principles (DSL-agnostic), see [Hierarchical Reduction](../hierarchical-reduction-memory-bound.md)
...
- [Hierarchical Reduction General Principles](../hierarchical-reduction-memory-bound.md)
