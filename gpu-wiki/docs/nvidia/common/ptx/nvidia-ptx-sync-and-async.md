# NVIDIA PTX Synchronization and Async Operations

PTX synchronization and asynchronous-copy instructions: CTA barriers, fences, mbarrier, and cp.async on NVIDIA GPUs.
...
- [PTX MMA Instruction Evolution (NVIDIA General)](nvidia-ptx-mma-instructions.md)
- [PTX Instruction Evolution: A100, H100, B200](ptx-instruction-evolution-a100-h100-b200.md)
- [PTX Core Instruction Set](ptx-instruction-set.md)
- [PTX Programming Model and Basics](ptx-programming-model.md)
- [PTX/SASS Low-Level Programming Practices](ptx-sass-programming.md)
