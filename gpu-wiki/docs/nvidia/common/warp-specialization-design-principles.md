...
> Related documentation: [PTX Synchronization and Asynchronous Operations](ptx/nvidia-ptx-sync-and-async.md) | [Occupancy Tuning](occupancy-tuning-by-arch.md) | [Register Pressure and Occupancy](register-pressure-warp-occupancy.md)
