...
> [`../triton/sm100-sparse-decode-split-k-pitfalls.md`](../../triton/pitfalls/sm100-sparse-decode-split-k-pitfalls.md)
> Trap #6.
...
- Blackwell hardware primitives (tcgen05, tmem, mbarrier):
  [`../../../kernel-opt/nvidia/common/blackwell/hardware/`](../../hardware/)
