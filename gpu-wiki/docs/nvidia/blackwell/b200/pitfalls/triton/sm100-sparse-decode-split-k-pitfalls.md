...
[`docs/nvidia/common/ref-docs/ncu-measurement-discipline.md`](../../../../common/ref-docs/ncu-measurement-discipline.md))
...
- `Est. Speedup %` is a ceiling, not a wall-time delta:
  [`docs/nvidia/common/ref-docs/ncu-rule-est-speedup-meta-rules.md`](../../../../common/ref-docs/ncu-rule-est-speedup-meta-rules.md)
- Gluon-on-Blackwell counterpart traps (when porting these kernels off Triton):
  [`../gluon/README.md`](../gluon/README.md)
- Blackwell kernel knowledge (split-K, flash-decode, sparse MLA):
  [`../../../kernel-opt/`](../../../kernel-opt/)
