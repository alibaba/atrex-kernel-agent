# nvidia/blackwell/techniques

Index for `nvidia/blackwell/techniques/`.
...
| [fine-grained-quantization.md](fine-grained-quantization.md) | Fine-Grained FP8/FP4 Quantization |
| [kernel-fusion.md](kernel-fusion.md) | Kernel Fusion |
| [persistent-kernels.md](persistent-kernels.md) | Persistent Kernels with CLC |
...
| [tile-scheduling.md](tile-scheduling.md) | L2 cache reuse analysis for different schedulers |
