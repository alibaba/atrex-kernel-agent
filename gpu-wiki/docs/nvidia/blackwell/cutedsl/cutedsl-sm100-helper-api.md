...
- Block-scaled: `make_blockscaled_trivial_tiled_mma(..., sf_dtype=cutlass.Float8E4M3, sf_vec_size=16)` (NVFP4 = 16, MXFP = 32). Mechanism: [blackwell-cutedsl-sm100.md §1](blackwell-cutedsl-sm100.md), [../../../kernel-opt/nvidia/common/blackwell/hardware/tcgen05-mma.md](../hardware/tcgen05-mma.md).
...
```
Also `cluster_shape_to_tma_atom_B/SFB`. Sync model and 16-byte alignment: [../../../kernel-opt/nvidia/common/blackwell/hardware/tma.md](../hardware/tma.md) — let the pipeline class drive the mbarriers.
...
- [blackwell hardware mechanism docs](../hardware/README.md) — TMEM / tcgen05 / TMA / 2sm / CLC
