...
- **Prerequisites**: [Hopper Hardware Specs](../../common/hardware-specs/hopper.md) + [Common Optimization Checklist](common_optimizations.md)
- **Cross-Architecture Reference**: [CDNA4 GEMM Optimization](../../../amd/gluon/gfx950/matmul.md) | [CDNA3 GEMM Optimization](../../../amd/gluon/gfx942/pattern_overview.md) (5 files)
- **wgmma Details**: [PTX MMA Instruction Evolution](../../common/ptx/nvidia-ptx-mma-instructions.md) — wgmma instruction specification
- **CuTeDSL**: [CuTeDSL SM90-Specific Features](../cutedsl/hopper-cutedsl-sm90.md) — WGMMA usage in CuTeDSL
- **Converter Reference**: [Hopper Matrix Multiply Conversion](../converter/hopper/matrix_multiply.md)
