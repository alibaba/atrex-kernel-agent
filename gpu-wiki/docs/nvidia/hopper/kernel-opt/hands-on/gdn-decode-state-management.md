...
- **Hopper Pitfalls**: [Hopper Practical Pitfalls](../../ref-docs/gluon/pitfalls.md) — Case studies including chunk_gated_delta_rule
- **Linear Attention**: [Chunk Linear Attention Optimization](../../ref-docs/gluon/linear_attention.md) — Similar state management patterns
