...
- **PTX Instruction Set**: [PTX Core Instruction Set](../../../common/ref-docs/ptx-instruction-set.md) — Floating-point instruction reference
- **ISA Reference**: [Hopper ISA Instruction Patterns](../../ref-docs/gluon/isa_patterns.md) — SASS instruction throughput
- **Instruction-Level Optimization**: [GPU Instruction-Level Optimization](../../../../generic/ref-docs/gpu-instruction-optimization.md) — Precision vs. throughput trade-offs
