...
> **General Basics**: For the principles and algorithms of Persistent Kernel and GROUP_SIZE_M Swizzle, see [Persistent Kernel and Tile Scheduling](../../../../generic/kernel-opt/hands-on/persistent-kernel-tile-scheduling.md). This document only records Hopper-specific configurations and experience.
...
- **General Pattern**: [Persistent Kernel and Tile Scheduling](../../../../generic/kernel-opt/hands-on/persistent-kernel-tile-scheduling.md) — GROUP_SIZE_M Swizzle algorithm and practical experience
- **General Optimization**: [Hopper Common ISA Optimization Checklist](../../ref-docs/gluon/common_optimizations.md)
