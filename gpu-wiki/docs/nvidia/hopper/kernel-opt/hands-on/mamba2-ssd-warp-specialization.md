...
- **Linear Attention**: [Chunk Linear Attention Optimization](../../ref-docs/gluon/linear_attention.md) — Similar multi-stage computation patterns
- **Profiling**: [Hopper Profiling Guide](../../ref-docs/gluon/profiling_guide.md) — Analyzing warp occupancy
