...
- **CuTeDSL Pipeline**: [CuTeDSL Software Pipeline and Synchronization Patterns](../../../common/ref-docs/cutedsl/cutedsl-pipeline-patterns.md) — producer/consumer state machine
- **PTX Synchronization**: [PTX Synchronization and Async Operations](../../../common/ref-docs/nvidia-ptx-sync-and-async.md) — mbarrier details
