...
- **Cross-Architecture Comparison**: [CDNA3 Hardware Specs](../../../amd/cdna3/mi300x/hardware-specs/hardware_specs_mi300x.md) | [CDNA4 Hardware Specs](../../../amd/cdna4/hardware-specs/hardware_specs_mi355x.md)
- **General Spec Tables**: [NVIDIA Compute Capability Reference Table](../../common/kernel-opt/nvidia-compute-capabilities.md)
- **Downstream Consumption**: [Hopper ISA Optimization Checklist](../ref-docs/gluon/common_optimizations.md)
