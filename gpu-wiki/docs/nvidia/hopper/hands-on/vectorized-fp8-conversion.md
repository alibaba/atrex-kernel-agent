...
- **PTX Instruction Set**: [PTX Core Instruction Set](../../common/ptx/ptx-instruction-set.md) — Floating-point instruction reference
- **ISA Reference**: [Hopper ISA Instruction Patterns](../gluon/isa_patterns.md) — SASS instruction throughput
- **Instruction-Level Optimization**: [GPU Instruction-Level Optimization](../../../generic/gpu-instruction-optimization.md) — Precision vs. throughput trade-offs
