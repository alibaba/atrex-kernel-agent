...
- **General Optimization**: [Hopper Common ISA Optimization Checklist](../gluon/common_optimizations.md)
- **Hardware Specifications**: [Hopper Hardware Specification Table](../../common/hardware-specs/hopper.md) — SM count
