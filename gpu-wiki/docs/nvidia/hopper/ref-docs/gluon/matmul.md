...
- **Cross-Architecture Reference**: [CDNA4 GEMM Optimization](../../../../amd/cdna4/ref-docs/gluon/matmul.md) | [CDNA3 GEMM Optimization](../../../../amd/cdna3/mi308x/kernel-opt/gluon/pattern_overview.md) (5 files)
- **wgmma Details**: [PTX MMA Instruction Evolution](../../../common/ref-docs/nvidia-ptx-mma-instructions.md) — wgmma instruction specification
- **CuTeDSL**: [CuTeDSL SM90-Specific Features](../cutedsl/hopper-cutedsl-sm90.md) — WGMMA usage in CuTeDSL
- **Converter Reference**: [Hopper Matrix Multiply Conversion](../../converter/hopper.md)
