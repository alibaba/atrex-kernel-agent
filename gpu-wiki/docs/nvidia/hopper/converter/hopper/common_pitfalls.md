...
- [Hopper Layout Mapping (Triton → Gluon)](layouts.md)
...
- [Common Errors and Solutions](../../../../amd/converter/cdna3/common_pitfalls.md)
- [Common Errors & Solutions (CDNA4 / gfx950)](../../../../amd/converter/cdna4/common_pitfalls.md)
- [AMD MFMA Matrix Core Programming Guide](../../../../amd/common/amd-mfma-matrix-cores.md)
