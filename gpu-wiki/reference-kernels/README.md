...
1. First read [`docs/ref-docs/amd/flydsl/flydsl-inline-asm-patterns.md`](../docs/amd/flydsl/flydsl-inline-asm-patterns.md) for pattern overview (10 sections: API forms, AMDGPU constraint strings, eight usage categories, `has_side_effects` selection, comparison with CuTeDSL, pitfalls).
