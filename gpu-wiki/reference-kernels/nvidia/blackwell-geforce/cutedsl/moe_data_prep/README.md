...
- Optimization journey: [`docs/ref-docs/nvidia/cutedsl/sm120/sm120-moe-data-prep-optimization.md`](../../../../../docs/nvidia/blackwell-geforce/cutedsl/sm120-moe-data-prep-optimization.md)
- Pitfalls: [`docs/pitfalls/nvidia/cutedsl/sm120-moe-data-prep-pitfalls.md`](../../../../../docs/nvidia/blackwell-geforce/cutedsl/pitfalls/sm120-moe-data-prep-pitfalls.md)
- Quick reference: [`docs/kernel-opt/nvidia/cutedsl/sm120/sm120-moe-data-prep.md`](../../../../../docs/nvidia/blackwell-geforce/cutedsl/sm120-moe-data-prep.md)
- Cross-arch lesson (NCU rebalancing): [`docs/ref-docs/nvidia/common/ncu-rule-est-speedup-meta-rules.md`](../../../../../docs/nvidia/common/profiling/ncu-rule-est-speedup-meta-rules.md)
