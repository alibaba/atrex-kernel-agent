...
- [cdna3-fused-moe-fp8-ptpc-atrex-v2.md](../../../../../../docs/amd/cdna3/mi308x/ref-docs/flydsl/cdna3-fused-moe-fp8-ptpc-atrex-v2.md)

Pitfalls and invalid evidence boundaries:

- [fused-moe-fp8-ptpc-pitfalls.md](../../../../../../docs/amd/cdna3/mi308x/pitfalls/flydsl/fused-moe-fp8-ptpc-pitfalls.md)
