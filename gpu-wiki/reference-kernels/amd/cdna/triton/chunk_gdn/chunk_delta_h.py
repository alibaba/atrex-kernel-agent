...
from op import exp, exp2, safe_exp
from utils import (
    is_amd,
    is_amd_cdna3,
    is_amd_cdna4,
...
def chunk_gated_delta_rule_fwd_h(
    ...
    """
    # gpu-wiki keeps this file as the tuned Triton fwd_h baseline.  The RTP
    # source can optionally dispatch to a separate CDNA4 Gluon implementation;
    # that path is intentionally not imported here so this reference remains
    # self-contained under reference-kernels/amd/cdna/triton/chunk_gdn.
