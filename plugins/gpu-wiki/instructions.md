...
Use `python3 tools/plugin.py call gpu-wiki.query --input scratch/wiki_request.json` with a JSON object:
...
used or reconsidered, using `record-experiment`. Do not copy payloads into telemetry or write canonical memory directly.
