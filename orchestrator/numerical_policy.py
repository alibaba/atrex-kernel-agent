...
from .infrastructure_retry import InfrastructureUnavailable, check_review_service, check_transport, retry_infrastructure, retry_review
    ...
    try:
        ...
        def review_once():
            with tempfile.TemporaryDirectory(prefix="atrex-numerical-review-") as temporary:
                ...
                return validate_review(review, digest, set(review_files) | {"evaluation.json", "numerical_suite.json"})
        errors = retry_review(
            workspace,
